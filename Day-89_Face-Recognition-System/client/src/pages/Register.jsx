...
export default function Register() {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-[80vh] text-white px-4 overflow-hidden">
      <div className="absolute w-72 h-72 bg-green-500/20 blur-[120px] rounded-full -top-20 animate-pulse" />
      <div className="absolute w-72 h-72 bg-blue-500/20 blur-[120px] rounded-full bottom-0 right-0 animate-pulse" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <motion.div whileFocus={{ scale: 1.02 }}>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lg bg-black/40 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition"
            />
          </motion.div>
